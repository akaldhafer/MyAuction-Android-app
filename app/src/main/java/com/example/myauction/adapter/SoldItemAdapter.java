...
public class SoldItemAdapter extends RecyclerView.Adapter<SoldItemAdapter.ViewHolder> {
    ...
    public SoldItemAdapter(Context context, ArrayList<ItemModel> arrayList) {
    ...
    @NonNull
    @Override
    public SoldItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_my_sold_items, parent, false);
        SoldItemAdapter.ViewHolder holder = new SoldItemAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull SoldItemAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.vBuyerEmail.setText(String.valueOf(buyerEmail));
        //set the image
        ...
        holder.send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String[] TO ={buyerEmail};
                String[] CC = {sellerEmail};
                String subject = title+" Seller";
                String body = "I would like to contact you about the following item to finish the payment and delivery process\n\n"
                        + title+"\n"+description+"\n"+soldPrice+"\nFrom the seller of the item you won the auction\n"+sellerEmail
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private TextView vTitle, vDesc, vStartPrice, vSoldPrice, vBuyerEmail;
        private ImageView imageView, send;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            vTitle = itemView.findViewById(R.id.sTitle);
            vDesc = itemView.findViewById(R.id.sDesc);
            vStartPrice = itemView.findViewById(R.id.sStartPrice);
            vSoldPrice = itemView.findViewById(R.id.sSoldPrice);
            vBuyerEmail = itemView.findViewById(R.id.sBuyerEmail);
            send = itemView.findViewById(R.id.sSendEmail);
