...
import com.example.myauction.adapter.CurrentBiddingAdapter;
...
public class CurrentBiddingItem extends AppCompatActivity implements ViewItemFetchMessage {
    private RecyclerView ListDataView;
    private CurrentBiddingAdapter Adapter;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("My Current Bidding List");
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CurrentBiddingItem.this, UserMenu.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CurrentBiddingItem.this, UserProfile.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }
    ...
    public void RecyclerViewMethod() {
        ...
        Adapter = new CurrentBiddingAdapter(this, arrayList);
    ...
    public void onUpdateSuccess(ItemModel message) {
        if(message != null && message.getBidderEmailList().contains(email) && message.getIsActive().equals("active")){
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(CurrentBiddingItem.this, message, Toast.LENGTH_LONG).show();
